...
//массив initialData для начальной загрузки данных при запуске приложения.
const initialData = [
  {
  ...
  btn.addEventListener('click', () => {
    try {
      if (inputText.value.length > 500 || inputText.value.length < 50) {
        throw new Error ('длина введенного значения не соответствует требованиям (от 50 до 500 символов)')
      }
